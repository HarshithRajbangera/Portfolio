      ...
      <div className="home-class">
        <div className="home-content">
          ...
          <p className="content">Highly motivated and results-oriented Full Stack Developer with a strong foundation in C and Java. Proven
            ...
            internships and projects. Possessing a strong interest in cybersecurity, I am eager to contribute to a dynamic
            team and leverage my skills to build secure and innovative web applications.</p>
        </div>
      </div>
    </>
  )
